...
// ADICIONAR NOVOS PACIENTES SISTEMA[
    public void adicionarPacientesSist(String nome, int idade, int convenio) {
...
// USUARIOS ADICIONAR NOVO PACIENTE A ARRAY
    ...
    public void alterarPaciente(int posicao, String novoNome, int novaIdade, int novoConvenio) {
        int tamArray = pacientes.size();
        posicao--;
        if (posicao > 0 && posicao < tamArray++) {
...
//GERENCIADOR DE DENTISTA
    ...
    public void incluirDentistas(String nome, String cro) {
...
//GERENCIADOR DE TRATAMENTO
    ...
    public void incluirTratamentos(String nome, double preco) {
        ...
        tratamentos.add(new Tratamento("Prótese Dentaria Removivel(Dentadura)", 1900));
